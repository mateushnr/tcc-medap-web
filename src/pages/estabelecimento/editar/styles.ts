...
export const EditEstablishmentContainer = styled('article', {
  '& >': {
    [`${Box}`]: {
      display: 'flex',
...
export const EstablishmentBeingEditedContainer = styled('header', {
  display: 'flex',
...
export const EstablishmentInfoContainer = styled('section', {
  display: 'flex',
  alignItems: 'center',
  gap: '$3',
})
...
export const EditEstablishmentForm = styled('form', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$6',
})
...
export const EstablishmentData = styled('section', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$4',
})

export const EstablishmentDataHeader = styled('header', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$3',
...
export const EstablishmentDataFields = styled('div', {
  display: 'grid',
...
export const EstablishmentStatusField = styled('div', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$3',
...
export const EstablishmentTargetCustomerField = styled('div', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$3',

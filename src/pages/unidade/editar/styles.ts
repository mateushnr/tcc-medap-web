...
export const EditUnityContainer = styled('article', {
  '& >': {
    [`${Box}`]: {
      display: 'flex',
...
export const UnityBeingEditedContainer = styled('header', {
  display: 'flex',
...
export const UnityInfoContainer = styled('section', {
  display: 'flex',
  alignItems: 'center',
  gap: '$3',
})
...
export const EditUnityForm = styled('form', {
  display: 'flex',
  flexDirection: 'column',
  gap: '$6',
})
